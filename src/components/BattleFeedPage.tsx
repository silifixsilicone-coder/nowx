...
export const BattleFeedPage: React.FC<BattleFeedPageProps> = ({ onJoinBattle, onViewChange }) => {
  ...
  const [battles, setBattles] = useState<Battle[]>([
    ...
    {
      id: 'cringe_vlogs',
      title: 'Slow-mo Lifestyle Vlogs vs 24/7 Gaming Streams',
      category: 'Internet Culture 😂',
      player1: { name: 'Aesthetic Vloggers 🍵', image: 'https://images.unsplash.com/photo-1618477388954-7852f32655ec?w=200&h=200&fit=crop', votes: 12100 },
      player2: { name: 'Gaming Ragers 🎮', image: 'https://images.unsplash.com/photo-1618401471353-b98aedd07871?w=200&h=200&fit=crop', votes: 6450 },
      totalVotes: 18550,
      topComment: { user: 'Meme_Lord_69', text: 'I would rather watch a speed bump for 3 hours than watch another lifestyle guru pour green tea in slow motion! 🍵😂', Camp: 'Ragers Camp' },
    ...
    {
      id: 'cricket_legend',
      title: 'M.S. Dhoni Finishing Stance vs AB de Villiers 360 Shots',
      category: 'Cricket 🏏',
      player1: { name: 'Thala Finisher 🐐', image: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=200&h=200&fit=crop', votes: 16800 },
      player2: { name: 'Mr 360 ABD 🛸', image: 'https://images.unsplash.com/photo-1542751371-adc38448a05e?w=200&h=200&fit=crop', votes: 14200 },
      totalVotes: 31000,
      topComment: { user: 'Sarcastic_King', text: 'Stakes: Ultimate Finisher title lobby! Voting is going crazy! 🏏🔥 ABD can hit any direction but Thala is absolute calm! 🐐', Camp: 'Thala Camp' },
